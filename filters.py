...
#     cv2.imwrite(os.path.join(home, os.path.basename(sf_name)),output)
...
def removebg(img):
    ...
    output = remove(img)
    # output.save("removed_BG.png")
    output.save(os.path.join(home, 'Removed_BG_'+ os.path.basename(sf_name)[0:-3] + 'png'))
...
def cartoon(img):
    ...
    cv2.imwrite(os.path.join(home, 'cartoon_'+os.path.basename(sf_name)),cartoon)
def cartoonize(img, k):
    ...
    cv2.imwrite(os.path.join(home, 'anime_'+os.path.basename(sf_name)),cartoon)
